...
const Banner = () => {
  return (
    <>
        <div className="flex flex-col md:flex-row-reverse py-12 px-8 justify-between items-center gap-12">
            ...
            <div className="md:w-1/2 w-full">
                {/* Text Area */}
                <h1 className="md:text-5xl text-2xl font-medium mb-7 font-mono justify-evenly">Welcome to Crossword Book-Store</h1>
