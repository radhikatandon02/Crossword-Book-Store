  ...
  return (
    <>
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <section className="grid md:grid-cols-4 xl:grid-cols-4 xl:grid-rows-2 xl:grid-flow-col gap-4">
              ...
              <div className="row-span-4 bg-white shadow rounded-lg">
                ...
                <div className="overflow-y-auto h-15" style={{maxHeight: '24rem'}}>
              ...
              <div className="flex items-center p-8 h-32 w-full bg-white shadow rounded-lg">
